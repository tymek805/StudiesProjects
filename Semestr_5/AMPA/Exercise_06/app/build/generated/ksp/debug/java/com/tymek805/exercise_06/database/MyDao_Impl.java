...
public final class MyDao_Impl implements MyDao {
  ...
  @Override
  public LiveData<List<MyItem>> getAllData() {
    final String _sql = "SELECT * FROM items ORDER BY id ASC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return __db.getInvalidationTracker().createLiveData(new String[] {"items"}, false, new Callable<List<MyItem>>() {
      @Override
      @Nullable
      public List<MyItem> call() throws Exception {
