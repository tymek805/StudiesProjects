...
public final class FragmentMainBinding implements ViewBinding {
  ...
  private FragmentMainBinding(@NonNull ConstraintLayout rootView, @NonNull TextView authorTextView,
      @NonNull ImageView imageView, @NonNull TextView invitationTextView) {
  ...
  public static FragmentMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMainBinding((ConstraintLayout) rootView, authorTextView, imageView,
          invitationTextView);
    }
