...
public class Z4c {
    ...
    private static Set<String> zbiorZmiennych;   // zbior nazw spojnikowm wystepujacych w formule
    ...
    private static Set<String> formula() { //---------------------------------- formula
        ...
        switch (sym) {
            case ZMIENNA_ZDANIOWA: zmienne.add(nazwa); pobSymbol(); break;
            case FALSUM   :
            case VERUM    :
    ...
    public static void main(String[] args) {
        if (args.length == 1) {
            ...
            if (sym == symbol.KONIEC) blad(0);
                ...
                else System.out.println("W formule \"" + formula + "\" wystepuje nastepujaca liczba zmiennych: " + zbiorZmiennych.size());
            }
        }
        else
            System.out.println("Wywolanie: Z4c \"<formula>\"");
    }  // koniec main
}    // koniec klasy