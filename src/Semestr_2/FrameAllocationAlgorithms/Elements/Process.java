package Semestr_2.FrameAllocationAlgorithms.Elements;
...
//            pages = new Page[]{new Page(11), new Page(14)   , new Page(15), new Page(13), new Page(12), new Page(14), new Page(11), new Page(12), new Page(13), new Page(15), new Page(14), new Page(11)};
    ...
    public LinkedList<Page> getFrames() {return frames;}
    public void setFrames(LinkedList<Page> frames) {
        this.frames = frames;
    }

    public int getPageFaultsInterval() {return pageFaultsInterval;}
    public void incrementPageFaultsInterval(){pageFaultsInterval++;}
    public void resetPageFaultsInterval() {pageFaultsInterval = 0;}
}
