...
public class ControllingFrequency implements FrameAlgorithm {
    ...
    public ControllingFrequency(int MEMORY_SIZE, int NUMBER_OF_PROCESSES, Process[] processes, int DELTA_T, double botCoherent, double topCoherent){
    ...
    @Override
    public boolean getStatic() {return false;}
}