...
import ssh_logs
from ssh_logs import get_user_from_log
...
def cli():
    ...
    subparsers.add_parser('users', help="List all users from the log file")
    ...
    match args.command:
        ...
        case 'users':
            [print(get_user_from_log(log)) for log in logs]
        case 'msg_type':
