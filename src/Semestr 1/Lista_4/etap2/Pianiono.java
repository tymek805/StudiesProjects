...
public class Pianiono extends instrumentKlawiszowy{
    ...
    public String getTypBudowy(){return typBudowy;}
    public boolean getCzyWyciszony() {return czyWyciszony;}

    // Settery
    public void setCena(int cena){this.cena = cena;}
    public void setTypBudowy(String typBudowy){this.typBudowy = typBudowy;}
